...
permalink: /01_the_machine_learning_landscape
nb_path: _notebooks/01_the_machine_learning_landscape.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/01_the_machine_learning_landscape.ipynb
-->
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Scikit-Learn ≥0.20 is required</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># To plot pretty figures directly within Jupyter</span>
...
<pre>Downloading oecd_bli_2015.csv
...
<pre>/Users/ageron/miniconda3/envs/tf2/lib/python3.6/site-packages/sklearn/linear_model/base.py:485: RuntimeWarning: internal gelsd driver lwork query error, required iwork dimension not returned. This is likely the result of LAPACK bug 0038, fixed in LAPACK 3.2.2 (released July 21, 2010). Falling back to &#39;gelss&#39; driver.
  linalg.lstsq(X, y)
</pre>
</div>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Where to save the figures</span>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Saving figure money_happy_scatterplot
</pre>
</div>
</div>
...
<div class="output_png output_subarea ">
<img src="data:image/png;base64,
"
>
</div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Saving figure tweaking_model_params_plot
</pre>
</div>
</div>
...
<div class="output_png output_subarea ">
<img src="data:image/png;base64,
"
>
</div>
...
<div class="output_text output_subarea output_execute_result">
<pre>(4.853052800266436, 4.911544589158484e-05)</pre>
</div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Saving figure best_fit_model_plot
</pre>
</div>
</div>
...
<div class="output_png output_subarea ">
<img src="data:image/png;base64,
"
>
</div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Saving figure cyprus_prediction_plot
</pre>
</div>
</div>
...
<div class="output_png output_subarea ">
<img src="data:image/png;base64,
"
>
</div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Saving figure representative_training_data_scatterplot
</pre>
</div>
</div>
...
<div class="output_subarea output_stream output_stderr output_text">
<pre>/Users/ageron/miniconda3/envs/tf2/lib/python3.6/site-packages/numpy/lib/nanfunctions.py:1508: RuntimeWarning: overflow encountered in multiply
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Saving figure overfitting_model_plot
</pre>
</div>
</div>
...
<div class="output_png output_subarea ">
<img src="data:image/png;base64,
"
>
</div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Saving figure ridge_model_plot
</pre>
</div>
</div>
